...
def generate_qr_image(texto, tipo):
    """Función unificada para generar QR - reemplaza crear_qr.py"""
    try:
        qr = qrcode.QRCode(
            version=None,
...
def favicon():
    return send_from_directory(os.path.join(app.root_path, 'src/static'),
...
if __name__ == "__main__":
    ...
    print(f"Carpeta de templates: {app.template_folder}")
    print(f"Carpeta static: {app.static_folder}")
